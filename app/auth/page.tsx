        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              type="button"
              className="w-full flex items-center justify-center gap-3 border border-border rounded-md px-4 py-3 text-sm font-dm-sans font-medium hover:bg-surface-raised transition-colors"
            >
