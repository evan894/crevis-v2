...
export default function DashboardPage() {
  ...
  const refreshData = async (showLoading = false) => {
    ...
    // We need to fetch the user again to ensure we have the context
  ...
  useEffect(() => {
    ...
    // Set up real-time subscription for orders to keep stats in sync
    const channel = supabase
      ...
      .on(
        ...
        () => {
          console.log("Change detected in orders table, refreshing stats...");
      ...
      .on(
        ...
        () => {
          console.log("Change detected in sellers table, refreshing stats...");
          refreshData(false);
        }
      )
      .subscribe();
          ...
          <div className="bg-surface-raised border border-border rounded-xl p-5 shadow-sm flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
            ...
            <div className="flex-1 flex flex-col gap-2 min-w-0">
              ...
              <div className="flex items-center gap-2 bg-surface border border-border rounded-md px-3 py-2">
                ...
                <button
                  id="copy-bothandle"
                  onClick={() => handleCopyDashboard("https://t.me/Crevis_shop_bot", "bothandle")}
